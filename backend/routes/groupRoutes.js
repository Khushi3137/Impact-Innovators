...
router.get('/join-requests', groupController.getPendingJoinRequests);
...
router.post('/:groupId/join-requests/:userId/accept', groupController.acceptJoinRequest);
router.post('/:groupId/join-requests/:userId/reject', groupController.rejectJoinRequest);
router.post('/:groupId/accept-invite', groupController.acceptGroupInvite);
