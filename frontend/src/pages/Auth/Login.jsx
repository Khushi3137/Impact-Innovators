...
function Login() {
  ...
  const getLoginErrorMessage = (error) => {
    ...
    if (error.code === "ERR_NETWORK") {
      return "Cannot reach the backend server. Start it from the backend folder and try again.";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(location.state?.from?.pathname + location.state?.from?.search || "/dashboard", { replace: true });
    } catch (error) {
